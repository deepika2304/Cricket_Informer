package com.cricket.api.services.impl;
...
//	}
	...
	//Matches History all matches available in our database
	@Override
	        ...
	        try {
	            ...
	            for (Element match : liveScoreElements) {
	              //  HashMap<String, String> liveMatchInfo = new LinkedHashMap<>();
	                ...
	                String liveTeam = match.select("div.cb-text-live").text();
