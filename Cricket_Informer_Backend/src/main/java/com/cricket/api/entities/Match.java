...
public class Match {
	...
	public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore,
			String bowlTeam, String bowlTeamScore, String liveTeam, String matchLink, String textComplete,
	...
	public String getLiveTeam() {
		return liveTeam;
	}

	public void setLiveTeam(String liveTeam) {
		this.liveTeam = liveTeam;
	}
	...
	public String toString() {
		return "Match [matchId=" + matchId + ", teamHeading=" + teamHeading + ", matchNumberVenue=" + matchNumberVenue
				...
				+ ", bowlTeamScore=" + bowlTeamScore + ", liveTeam=" + liveTeam + ", matchLink=" + matchLink
